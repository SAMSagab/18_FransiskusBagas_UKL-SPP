...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!--Navbar Data -->
            <li class="nav-item">
                <a class="nav-link active" href="spp.php">
							...
							<div class="card">
                                ...
                                $no++;?>
                                        <tr class="text-xs font-weight-bold">
                                            ...
                                            <a class="btn btn-success" href="ubah_spp.php?id_spp=<?=$data_spp['id_spp']?>" ><i class="far fa-edit"></i></a>
											<a href="hapus_spp.php?id_spp=<?=$data_spp['id_spp']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                                            </td>
                                        </tr>
                                        <?php
                                        }
