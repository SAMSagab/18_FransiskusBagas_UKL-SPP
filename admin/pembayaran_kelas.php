                ...
                <div class="container-fluid">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
							...
							<div class="card">
                                ...
                                <a href="pembayaran.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Kembali
                                </button></a> <br><br><br>
                                <?php 
											include "../koneksi.php";
                                ...
                                <tbody>
                                    ...
                                    <td><a href="pembayaran_siswa.php?nisn=<?php echo $data['nisn']?>" class="fs-5 text-gray-800 text-hover-primary fw-boldest"><button class="btn btn-primary px-5">Cari Data</button></a><br></td>
                                    </tr>
                                    <tr>
                                    <?php 
                                    } 
                                ...
                                <br>
                                         <!--begin::Alert-->
											<div class="rounded border border-primary bg-light-primary border-dashed px-6 py-5">
												<a href="pembayaran.php" class="link-primary fw-bolder fs-6 me-1">Data pembayaran SPP</a>
